...
<form action="<?php echo BASE_URL; ?>categories/edit_action/<?php echo $id; ?>" method="post">
    <div class="box">
        ...
        <div class="box-body">
            ...
            >
                ...
                <input type="text" class="form-control" name="name" id="group_name" value="<?php echo $catInfo['name']; ?>">
            </div>
