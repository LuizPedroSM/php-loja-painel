...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo BASE_URL; ?>" class="logo">
      ...
      <span class="logo-lg"><b>Loja </b>Painel</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if( $viewData['user']->hasPermission('users_view') ): ?>
          <li class="<?php echo ($viewData['menuActive'] == 'users')? 'active' : ''; ?>"><a href="<?php echo BASE_URL; ?>users">
            <i class="fa fa-link"></i> <span>Usuários</span></a>
          </li>
        <?php endif; ?>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">Loja Painel</a>.</strong> Todos os direitos reservados.
  </footer>
